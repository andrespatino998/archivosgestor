$(document).ready(function () {
  ...
  tablaDepartamentos = $("#tablaDepartamentos").DataTable({
    ...
    columns: [
      ...
      {
        defaultContent:
          "<div class='text-center'><div class='btn-group1' style='text-align:center;'><button class='btn btn-primary btn-sm btnEditar data-toggle='tooltip'  title='Editar Departamento''><i class='material-icons'>edit</i></button><button class='btn btn-danger btn-sm btnBorrar data-toggle='tooltip'  title='Eliminar Departamento''><i class='material-icons'>delete</i></button></div></div>",
      },
    ],
    ...
    buttons: [
      ...
      },
      {
        ...
        customize: function (doc) {
          ...
          doc.content[1].margin = [ 0, 10, 100, 0 ]
  ...
  $("#formDepartamentos").submit(function (e) {
    ...
    nivel_criticidad = $.trim($("#nivel_criticidad ").val());

    if (departamento == "" || nivel_criticidad == "") {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        // toastr.success('Exito! El usuario ha sido registrado correctamente')
      },
    });
  ...
  $("#btnNuevo").click(function () {
    ...
    $(".modal-title").text("Registro de Departamentos");
    $("#modalDepartamentos").modal("show");

    $("#btnGuardar").click(function () {
      window.location.href = "tabladepartamentos.php";
    });
  ...
  $(document).on("click", ".btnEditar", function () {
    ...
    nivel_criticidad = fila.find("td:eq(2)").text();

    $("#departamento").val(departamento);
    $("#nivel_criticidad").val(nivel_criticidad);
    $(".modal-header").css("background-color", "#2B0082");
    $(".modal-header").css("color", "white");
  ...
  $(document).on("click", ".btnBorrar", function () {
    ...
    departamento = $(this).closest("tr").find("td:eq(1)").text();

    Swal.fire({
      title: "¿Quieres eliminar el departamento " + departamento + "?",
      ...
      if (result.isConfirmed) {
        window.location = "tabladepartamentos.php?id=" + id;
      }
    });
  });
});
