...
echo '<script src="../Util/Js/sweetalert2.min.js"></script>';
 ...
 if($_SESSION['id']==$_GET['id']){
    ...
    echo "<h1 value=printf('Affected rows (UPDATE): %d\n', $mysqli->affected_rows)'>";
    echo "</h1 hidden>";
    ...
    Swal.fire({
        icon: 'error',
        title: 'Oops...',
        text: 'No te puedes dar de baja',
      })
     </script>";

 }else {
     
    $mysqli->query("UPDATE usuarios SET baja = 1 where id = '".$_GET['id']."'");
...
<div class="col-lg-12">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
             <h1 class="h3 mb-0 text-gray-800" style="text-align:left;">Empleados</h1>
            <div class="col-xl-10" style="text-align:right;">
              
                <button  id="btnNuevo" type="button" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"  data-bs-toggle="modal" ><i class="fas fa-user-plus fa-sm text-white-50"></i> Nuevo Empleado</button>
            </div>
        </div>
</div>
                      ...
                      <div class="col-lg-3">
                         <div class="form-group">
                            ...
                            <div class="input-group">
                                    ...
                                    <input type="password" id="contrasena" name="contrasena" class="form-control"  maxlength="25">
                            ...
                            <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select type="text" class="form-control"  id="tipo_sangre" name="tipo_sangre" >
                                            ...
                                            <option value="B-">B-</option>
                                            <option value="AB-">AB-</option>
                                            <option value="SIN">DESCONOCIDO</option>
                                        </select>
                                    </div>               
                            </div>
                        <div class="col-lg-1"></div> 
...
<div class="modal fade" id="modalFecha" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <form id="formVacaciones"  method="post">    
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-bs-dismiss="modal" id="btnCancelar2">Cancelar</button>
